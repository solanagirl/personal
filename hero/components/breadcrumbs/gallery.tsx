    ...
    <div className="max-w-[900px] gap-2 grid grid-cols-12 grid-rows-2 px-8">
      ...
      <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-5">
        ...
        <CardFooter className="absolute bg-white/30 bottom-0 border-t-1 border-zinc-100/50 z-10 justify-between">
          <div>
            <p className="text-black text-tiny">Amy</p>
          </div>
          <Button className="text-tiny mr-10" color="primary" radius="full" size="lg">
            0xSolanaGirl
          </Button>
        </CardFooter>
      </Card>
      <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-7">
        <CardHeader className="absolute z-10 top-1 flex-col items-start">
          <p className="text-tiny text-white/60 uppercase font-bold">Lisbon 2023</p>
          <h4 className="text-white/90 font-medium text-xl">Breakpoint</h4>
        </CardHeader>
